      ...
      { ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>index.php/Salescontrol/editestimate"><i class="fa fa-circle-o"></i>Sales Estimate</a></li>

             <li ><a href="<?php echo base_url();?>index.php/Onlinecontrol/salesreturn"><i class="fa fa-circle-o"></i>Sales Return</a></li>
