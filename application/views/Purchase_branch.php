			...
			<div class="box-body">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<input type="text" name="voucherno"  readonly="" class="form-control" required autocomplete="off" id="voucherno" value="<?php echo $voucherno->result_array()[0]['NO'];?>">
					</div>
					...
					<div class="col-md-4">
						...
						<datalist id="supplier1">
							<?php foreach($supplier->result() as $gp){
                                      ?>
							<option disabled="" value="<?php echo $gp->suppliername;?>" data-supplierbalance="<?php echo $gp->currentbalance;?>" data-address="<?php echo $gp->address;?>" data-city="<?php echo $gp->city;?>" data-mobile="<?php echo $gp->mobile;?>" label="<?php echo $gp->ledgerid;?>" selected ></option>
							<?php  } ?>
						</datalist>
					</div>
				...
				<div class="row">
					<div class="col-md-4">
						<label>Vendor invoice no :</label>
							<input readonly="" type="text" value="" name="vendorinvoiceno" class="form-control" id="vendor" autocomplete="off">
					</div>
					<div class="col-md-4">
						<label>Invoice date :</label>
						<input readonly="" type="date" name="invoicedate" class="form-control" id="invoicedate" value="<?php $d=strtotime("now");; echo date("Y-m-d",$d);?>">
					</div>
					<div class="col-md-4">
						<label>Branch :</label>
						<select disabled="" class="form-control" name="branch" id="branch">
							<?php
            ...
            <div id="imageref"></div>
				...
				<hr>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<textarea class="form-control" id="narration" name="Narration" readonly=""></textarea>
						</div>
						<div class="col-md-6">
							<label>Transportation Company :</label>
							<textarea id="company" class="form-control" name="transportationcompany" readonly></textarea>
						</div>
					</div>
					<hr>
					<fieldset>
						...
						<div class="row">
							<div class="col-md-3">
								...
								<input type="text" value="" class="form-control" name="totalstockamount" id="totalstockamount" style="" readonly>
							</div>
							<div class="col-md-3">
								<label>Total Qty :</label>
								<input type="text" value="" class="form-control" name="totalqty" id="totalqty" readonly>
							</div>
							<div class="col-md-3">
								<label>Total Amount :</label>
								<input type="text" class="form-control" value="" name="totalamount" id="totalamount" readonly>
								<input type="hidden" value="" id="oldta" name="">
							</div>
							<div class="col-md-3">
								<label>Additional Cost :</label>
								<input type="text" value="0" class="form-control" value="" name="additionalcost" id="additionalcost" readonly>
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control" value="0.00" name="taxamount" id="taxamount" readonly>
								<input type="hidden" value="0.00" id="oldtx" name="">
							</div>
							<div class="col-md-3">
								<label>Bill Discount :</label>
								<input type="text"  value="0.00" class="form-control" name="billdiscount" id="billdiscount" readonly>
								<input type="hidden" value="0.00" id="oldbd" name="">
							</div>
							<div class="col-md-3">
								<label>Grand Total :</label>
								<input type="text" class="form-control" value="0.00" name="grandtotal" id="grandtotal" readonly>
								<input type="hidden" value="0.00" id="oldgt" name="">
							</div>
							<div class="col-md-3">
								<label style="color: black">Old Balance :</label>
								<input type="text" name="oldbalance" id="oldbalance" class="form-control" autocomplete="off" readonly>
							</div>
						</div>
					</fieldset>
					<hr>
					<fieldset style="font-size: 14px;background: #f0f0f0; font-style: bolder"><span style="text-align: center;"><h4 style="background-color: darkkhaki; padding: 5px; font-weight: 800;">PAYMENT</h4></span>
						...
						<div class="row form-group">
							...
							<div class="col-md-4 form-group">
								...
								<select disabled="" class="form-control" id="cash" name="cash" >
							...
							<div class="col-md-4 form-group">
								...
								<input readonly="" type="text" name="balance" id="balance" value="0.00" class="form-control" autocomplete="off">
						...
						<div class="row form-group">
							...
							<div class="col-md-4 form-group">
								...
								<input readonly="" type="text"  value="0.00" name="paidcash" id="paidcash" class="form-control" required autocomplete="off">
								<input type="hidden" value="0.00" id="oldpc" name="oldpc">
							</div>
							<div class="col-md-4 form-group">
								<label style="color: black">Paid Bank :</label>
								<input readonly="" type="text" value="0.00" name="paidbank" id="paidbank" class="form-control" required autocomplete="off">
                           ...
                           <input style=" width: 200px;" class="btn btn-warning" type="button" name="btnclose" class="form-control" value="Print" id="btnclose" >
				...
				<div class="row margin" style="text-align: center">
					<div class="offset-md-4" style="display: inline-block">
						<input class="btn btn-success" type="hidden" name="btnsave" value="Save" id="btnsave">
						<input class="btn btn-success" type="hidden" name="btnupdate" id="btnupdate" value="Update">
						<input class="btn btn-danger" type="hidden" name="btndelete" id="btndelete" value="Delete">
							<input class="btn btn-info" type="hidden" name="btnclear" value="Clear">
						   <input class="btn btn-warning" type="hidden" name="btnbarcode" value="Barcode" id="btnbarcode" >
					</div>
