  ...
  <section class="content">
    <div class="box box-default">
      <div class="box-body">
        <div class="row">
          <div class="col-md-6">
             <?php echo form_open_multipart('Onlinecontrol/insert_product') ?>
            <!-- <form method="get" action="<?php echo base_url(); ?>index.php/Onlinecontrol/insert_product"> -->
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-3" style ="display: none;">
                  ...
                  foreach ($code->result() as $key) { ?>
                    <input type="text" style="" value="<?php echo $key->NO; ?>" name="" id="unk">
                  <?php  } ?>
                </div>
                    ...
                    <tr>
                      ...
                      <td style="display: none;"><?php echo $row->imagpath; ?></td>
                       <td style="display: none;"><?php echo $row->unitid; ?></td>
                        ...
                        <td style="display: none;"><?php echo $row->narration; ?></td>
                    </tr>
                  <?php $n++;
                  } ?>
...
var table = document.getElementById('table');
  ...
  for (var i = 1; i < table.rows.length; i++)
  {
    table.rows[i].onclick = function() 
    {
      ...
      document.getElementById("narration").value = this.cells[19].innerHTML;
