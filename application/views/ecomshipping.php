   ...
   <section class="content">
     ...
     <div class="row">
          ...
          <div class="col-md-1" style="margin-top:25px;">
            <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/ecomshipping">
          </div>
     </div>
     <div class="row">
          <div class="col-md-5">
                ...
                <tbody id="myTable">
                  <?php
                   ...
                   <td align="center" ><?php if ($key->item_stitch==1) { ?> 
                    <input type="checkbox" class="clstitch" name="stitch"   id="stitch<?php echo $n; ?>" value="1" checked disabled>
                    <?php  } 
                    else{
                    ?>
                    <input type="checkbox" class="clstitch" name="stitch"  id="stitch<?php echo $n; ?>" value="0" disabled>
                    <?php } ?>
                    </td>

                    <td align="center" >  <?php if ($key->item_shipped==1) { ?> 
                    <input type="checkbox" class="clsshipped"  name="shipped" id="shipped<?php echo $n; ?>" value="1" checked disabled>
                    <?php  } 
                    else{
                    ?>
                    <input type="checkbox" class="clsshipped"  name="shipped" id="shipped<?php echo $n; ?>" value="0" disabled>
                    <?php } ?>
                    </td>
                    <td align="center" >  <?php if ($key->item_received==1) { ?> 
                    ...
                    <td align="center" >  <?php if ($key->item_delivery==1) { ?> 
           ...
           try{
            ...
            var referenceno=$(this).closest("tr").find ('.referenceno').text();
             ...
             if(status>2){
              ...
              alert("item not yet shipped from production house!!!")
            }
