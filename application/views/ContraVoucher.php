...
<a href="#" class="next" id="next">Next &raquo;</a></div>
    ...
    <div class="row">
      <div class="col-md-3">
               ...
               <div class="col-md-3">
                <div class="form-group">
                  <label class="form-control-placeholder" for="contact-person">Ref No:</label>
          ...
          <input type="date" class="form-control" id="receiptdate" name="receiptdate" value="<?php date_default_timezone_set('Asia/Kolkata'); echo date("Y-m-d");?>" required autocomplete="off">
        </div>
      </div>
      <div class="col-md-3">
    ...
    <div class="row">
       <div class="col-md-3">
         <div class="form-group">
           <label class="form-control-placeholder" for="contact-person">From :</label>
              ...
              <datalist id="cashlist" >
                ...
                ?>
                <option value="<?php echo $ledgers->ledgername; ?>"  label="<?php echo $ledgers->ledgerid;?>" data-balance="<?php echo $ledgers->currentbalance;?>" ></option>
                <?php } ?>
              </datalist>
               </div>
      </div>
      <div class="col-md-3">
                <div class="form-group">
                    <label class="form-control-placeholder" for="contact-person">From Account Balance :</label>
                    <input type="text" class="form-control" id="frombalance" name="frombalance" required autocomplete="off">
            <!--    <a href="<?php echo base_url();?>index.php/Onlinecontrol/supplier" class="pull-right">Add New Supplier</a> -->
                </div>
            </div>
                 <div class="col-md-3">
              <div class="form-group">
                  <label class="form-control-placeholder" for="contact-person">To :</label>
                 <input type="text" class="form-control" list="ledgerlist" required autocomplete="off"  name="ledger" id="ledger">
              <!-- <option value="0"  data-balance="0.00">Select Customer</option> -->
              <datalist id="ledgerlist" >
                <?php
                  foreach ($BankAndcashLedgers->result() as $led) {
                ?>
                ...
                <?php } ?>
                 ...
                 <div class="col-md-3">
                <div class="form-group">
                    <label class="form-control-placeholder" for="contact-person">To Account Balance :</label>
    ...
    <div class="row margin col-md-12 form-group txn-bottom-form" style="text-align: center;">
       <form action="<?php echo base_url();?>index.php/Onlinecontrol/contravoucher">
            ...
            <tr>
              ...
              <th >From</th>
               <th class="">TO</th>
                <th >Amount</th>
              <th class="">Ref No</th>
              <th class=""> From Balance</th>
              <th class="">To Balance</th>
              ...
              <TR>
                ...
                <td ><?php echo $row->cash; ?></td>
                 ...
                 <TD><?php echo $row->vendorinvoiceno;?></TD>
                  <TD ><?php echo $row->frombalance;?></TD>
           ...
           // $.noConflict();
            try {
              $.ajax({
                type: "POST",
                // dataType:"json",
                url: "<?php echo base_url() ?>index.php/Onlinecontrol/insert_contravoucher",
                data: {
                  'voucherno': voucherno,
                  'ledger': ledger,
