...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cheque Receipt</li>
      </ol>
    </section>
          ...
          <div class="row">
            ...
            <div class="form-group">
                ...
                <datalist id="supplier1">
                  ...
                  <?php foreach($customer->result() as $cust){
                    ?>
                    <option value="<?php echo $cust->ledgerid;?>" data-balance="<?php echo $cust->currentbalance;?>" label="<?php echo $cust->customername;?>"></option>
                    <?php
                  } ?>
                  </datalist>
