...
<!-- <link href="<?php echo base_url(); ?>css/sub/style.css?<?php echo time(); ?>" rel="stylesheet" type="text/css" media="all" /> -->
  ...
  <style type="text/css">
    #add_customer_column, #add_customer_column1{
      display: none;
    }
  </style>
</head>
        ...
        <ul class="nav navbar-nav">
          ...
          { ?>
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" data-toggle="dropdown"><i class="fa fa-gears dropdown-toggle"></i></a>

              <ul class="dropdown-menu">
                <!-- User image -->
                <li style="text-align: center; "><h3>Devoloper Section</h3></li>

                <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/direct_stock_report"><i class="fa fa-circle-o"></i>Direct Stock Report</a></li>

                <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/direct_stock"  class="disabled"><i class="fa fa-circle-o"></i>Direct stock</a></li>

                <li><a href="<?php echo base_url();?>index.php/Purchasecontrol/auto_purchase_table"><i class="fa fa-circle-o"></i>Direct Purchase</a></li>

                <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/auto_database_stock" class="disabled"><i class="fa fa-circle-o"></i>Change Database Stock</a></li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>Productsub"><i class="fa fa-circle-o"></i>Sub Add Product</a></li>
      ...
      { ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>Sales"><i class="fa fa-circle-o"></i>Sales Invoice</a></li>
            <li><a href="<?php echo base_url();?>index.php/Salescontrol/editsales?fromdate=<?php echo date("Y/m/d H:i:s");?>&todate=<?php echo date("Y/m/d H:i:s");?>"><i class="fa fa-circle-o"></i>Edit Sales</a></li>
            <li><a href="<?php echo base_url();?>index.php/Salescontrol/editestimate"><i class="fa fa-circle-o"></i>Sales Estimate</a></li> <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/salesreturn"><i class="fa fa-circle-o"></i>Sales Return</a></li>
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/salesorder"><i class="fa fa-circle-o"></i>Sales Order</a></li>

            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/importInvo"><i class="fa fa-circle-o"></i>Import Invoice</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/physicalstock"><i class="fa fa-circle-o"></i>Physical Stock</a></li>
             ...
             <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/banktransfer"><i class="fa fa-circle-o"></i>Bank Transfer</a></li>
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/PurchaseReport"><i class="fa fa-circle-o"></i>Purchase Report</a></li>
            ...
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/salesreport"><i class="fa fa-circle-o"></i>Sales Report</a></li>
            <li ><a href="<?php echo base_url();?>index.php/Onlinecontrol/salesrtnreport"><i class="fa fa-circle-o"></i>Sales Return Report</a></li>
            <li ><a href="<?php echo base_url();?>index.php/Onlinecontrol/salesrtnreport_ogi"><i class="fa fa-circle-o"></i>Sales Return Report 2</a></li>
            
            <li ><a href="<?php echo base_url();?>index.php/Esalescontrol/eCommerceAllreports"><i class="fa fa-circle-o"></i>Ecommerce Report</a></li>
            ...
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/stockreport"><i class="fa fa-circle-o"></i>Stock Report</a></li>
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/stockregisterPDTreport"><i class="fa fa-circle-o"></i>Stock Register Peoduct Report</a></li>
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/stockregisterreport"><i class="fa fa-circle-o"></i>Stock Register Report</a></li>
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/branchreport"><i class="fa fa-circle-o"></i>Branch Report</a></li>
            <li><a href="<?php echo base_url();?>index.php/Onlinecontrol/walletreport_super"><i class="fa fa-circle-o"></i>Wallet Report</a></li>
      ...
      <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>index.php/Esalescontrol/eCommercePaydetails"><i class="fa fa-circle-o"></i>Payment Details</a></li>
