      ...
      <div class="subdiv table-responsive" style="overflow-x: none;" id="startprint">
        <table style="width: 100% !important;" border="1" class="table table-hover" id="Purchasetable">
                    ...
                    <tbody id="myTable">
                       ...
                       <?php 
                      $n=1; 
                         foreach($PurchaseDetailsAll->result() as $row)
                             { ?>
                              <tr>
                                <td><?php echo $n;?></td>
                                ...
                                <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/pur_invoice_branch?a=<?php echo $row->voucherno;?>"><button class="btn btn-success">View</button></a></td>
