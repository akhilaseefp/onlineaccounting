	...
	$(document).ready(function() {
		...
		try{
			...
			if (currency==3) {
				...
				var Qty = $('#qty' + a).val();
				aed_purchaserate=purchaserate*20;

				var netamount = aed_purchaserate * Qty;
				var taxamount = 0;
				var taxpercentagee = 0;

				$('#tax' + a).val(taxpercentagee);
				$('#unitprice' + a).val(aed_purchaserate.toFixed(2));
				$('#amount' + a).val((aed_purchaserate * Qty).toFixed(2));
				$('#hsn' + a).val(hsn);
		...
		<div class="box box-default">
			<div class="box-body">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<input type="hidden" class="form-control" value="1" name="branch_currency" id="branch_currency">
