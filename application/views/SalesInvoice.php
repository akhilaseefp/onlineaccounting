			...
			try {
				$.ajax({
					...
					success: function (result) {
						...
						'" class="form-control" list="size" name="" value="0"></td><td style="display:none"><input type="text"  value="0" id="' + batch +
...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div style="color: green; font-weight: 800; text-align: center;">
			<?php foreach ($finyear->result() as $fyer) {
				?>
				<input type = "hidden" name = "finyear" id = "finyear" value = "<?php echo $fyer->finyear_id;?>" />Financial Year : <?php echo $fyer->fin_year;?> 
					...
					<TABLE id="dataTable1" border="1" class="table table-striped table-hover">
						...
						<tbody id="dataTable" width="100%" class="table table-hover">
								...
								<td>
									...
									<td> <input type="text" class="form-control" list="size" autocomplete="off" value="0" name="size" id="size1"></td>
...
{ 
	...
	$.ajax({
		type: "POST",
		url: "<?php echo base_url() ?>index.php/Salescontrol/inserttable_push",
		data: {
