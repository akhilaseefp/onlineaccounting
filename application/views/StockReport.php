...
<!-- <script type="text/javascript">
  ...
  <form method="post">
   ...
   <div class="subdiv table-responsive" style="margin: 10px;" id="startprintt">
    ...
    <tbody id= "myTable">
      ...
      <?php if (!$contentsqty[0] == 0) { ?>
        <tr >
          ...
          <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[0];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[0]; ?></a></td>
      ...
      <?php if (!$contentsqty[1] == 0) { ?>
        <tr >
          ...
          <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[1];?>&branch=<?php echo($branchname); ?>"><?php echo $contentsname[1]; ?></a></td>
        ...
        <tr >
          ...
          <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[2];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[2]; ?></a></td>
        ...
        <?php if (!$contentsqty[3] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[3];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[3]; ?></a></td>
        ...
        <?php if (!$contentsqty[4] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[4];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[4]; ?></a></td>
        ...
        <?php if (!$contentsqty[5] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[5];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[5]; ?></a></td>
        ...
        <?php }?>
         ...
         <?php if (!$contentsqty[6] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[6];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[6]; ?></a></td>
        ...
        <?php if (!$contentsqty[7] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[7];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[7]; ?></a></td>
        ...
        <?php if (!$contentsqty[8] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[8];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[8]; ?></a></td>
        ...
        <?php if (!$contentsqty[9] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[9];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[9]; ?></a></td>
        ...
        <?php if (!$contentsqty[10] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[10];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[10]; ?></a></td>
        ...
        <?php if (!$contentsqty[11] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[11];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[11]; ?></a></td>
        ...
        <?php if (!$contentsqty[12] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[12];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[12]; ?></a></td>
        ...
        <?php if (!$contentsqty[13] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[13];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[13]; ?></a></td>
        ...
        <?php if (!$contentsqty[14] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[14];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[14]; ?></a></td>
        ...
        <?php if (!$contentsqty[15] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[15];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[15]; ?></a></td>
        ...
        <?php if (!$contentsqty[16] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[16];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[16]; ?></a></td>
        ...
        <?php if (!$contentsqty[17] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[17];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[17]; ?></a></td>
        ...
        <?php if (!$contentsqty[18] == 0) { ?>
          <tr >
            ...
            <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[18];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[18]; ?></a></td>
        ...
        <?php if (!$contentsqty[19] == 0) { ?>
          <tr >
           ...
           <td><a href="<?php echo base_url();?>index.php/Onlinecontrol/StockReport_group?groupid=<?php echo $contentsgroup[19];?>&branch=<?php echo($branchname); ?>" target="_blank"><?php echo $contentsname[19]; ?></a></td>
