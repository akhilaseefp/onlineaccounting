...
<body>
  ...
  <div class="container-fluid">
   ...
   <div class="w3-container w3-row" style="background-image: linear-gradient(to top right,black,#3c3c3c );">
    <div class="w3-col s4">
      <img src="man.svg" class="w3-circle w3-margin-right" style="width:46px height:46px">
    </div>
    <div class="w3-col s8 w3-bar">
      ...
      <a href="#" class="w3-bar-item w3-button"><i class="fa fa-cog"></i></a>
            ...
            <ul class="list-unstyled components">
                <li >
                    <a href="#">
                        <i><img src="house.svg" height="20px" width="20px"></i>
                        Home
                    </a>
                    ...
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <i ><img src="shopping-bag.svg" height="20px" width="20px"> </i>
                        Sales
                    </a>
                ...
                <li>
                    ...
                    <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <i><img src="basket.svg" width="20px" height="20px"></i>
                        Purchase
                    </a>
                ...
                <li>
                    <a href="supplier.html">
                      <i><img src="meeting.svg" width="20px" height="20px"></i>  
                       Supplier
                    </a>
                </li>
                 ...
                 <li>
                    ...
                    <a href="#pageSubmenu2" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <i><img src="man.svg" width="20px" height="20px"></i>
                        user
                    </a>
                    ...
                    <li>
                    <a href="#">
                      <i><img src="diagram.svg" width="20px" height="20px"></i>  
                       Reports
                    </a>
                </li>
