   ...
   <section class="content">
     ...
     <div class="row">
          ...
          <div class="col-md-1" style="margin-top:25px;">
            <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/ecomshippingaed">
          </div>
     </div>
     <div class="row">
          <div class="col-md-5">
                ...
                <tbody id="myTable">
                  <?php
                   ...
                   <td align="center" ><?php if ($key->item_stitch==1) { ?> 
                    ...
                    <input type="checkbox" class="cldispatch"  name="dispatch" id="dispatch<?php echo $n; ?>" value="1" checked disabled>
                    <?php  } 
                    else{
                    ?>
                    <input type="checkbox" class="cldispatch"  name="dispatch" id="dispatch<?php echo $n; ?>" value="0" disabled>
                    <?php } ?>
                    </td>
