<div class="content-wrapper">
   ...
   <section class="content">
     <div class="box box-default">
        <div class="box-body">
          <form method="post" action="<?php echo base_url();?>index.php/Onlinecontrol/insert_paymentvoucher">
    <div class="row">
      <div class="col-md-3">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" id="supplier" name="supplier">
                    ...
                    <?php foreach($supp->result() as $sup){
                      ?>
                      <option value="<?php echo $sup->supplierid;?>" data-balance="<?php echo $sup->currentbalance;?>"><?php echo $sup->suppliername;?></option>
                      <?php
                    } 
                    ?>
                  </select>
    ...
    <div class="row margin col-md-12 form-group txn-bottom-form" style="text-align: center;">
      <div class="offset-md-4">
        ...
        <input class="btn btn-info" type="button" id="clear" name="clear" value="Clear">
